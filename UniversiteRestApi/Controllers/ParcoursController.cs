...
namespace UniversiteRestApi.Controllers
{
    ...
    public class ParcoursController : ControllerBase
    {
        ...
        private readonly CreateParcoursUseCase _createParcoursUseCase;

        public ParcoursController(IRepositoryFactory repositoryFactory, CreateParcoursUseCase createParcoursUseCase)
        {
            _repositoryFactory = repositoryFactory;
            _createParcoursUseCase = createParcoursUseCase;
        }
